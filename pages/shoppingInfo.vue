            ...
            >
                ...
                <ul>
                    ...
                    >
                        <NuxtLink
                            :class="
                                currentSection === '#purchase-description'
                                    ? 'text-blue_light'
                                    : 'text-gray_dark'
                            "
                    ...
                    >
                        <NuxtLink
                            :class="
                                currentSection === '#exchange-policy'
                                    ? 'text-blue_light'
                                    : 'text-gray_dark'
                            "
            ...
            <div>
                ...
                <div id="purchase-description">
                    ...
                    <ul class="mb-16 pl-24 list-disc">
                        <li class="mb-8">
                            於有良冊官方網站購物消費，需先註冊成為會員，以利後續追蹤訂單狀態。
                        </li>
                        <li>有良冊官方網站購物流程：</li>
                    </ul>
                    <div class="flex flex-wrap lt-md:block mb-24">
                        ...
                        >
                            <div :class="step.widthClass">
                                <p class="bg-blue_dark text-center text-white py-6">
                                    {{ step.title }}
                                </p>
                ...
                <div id="exchange-policy">
                    ...
                    <ol class="marker:text-blue_light">
                        <li v-for="policy in exchangePolicy" :key="policy.title" class="mb-16">
                            ...
                            <ul
                                class="pl-20 marker:text-primary mb-32"
                                :class="policy.contentListTypeClass"
                            >
                                <li
